...
import com.brian.lotteryhelper.group.Data1_RandomGroup;
...
//					 total += lotteryList.size();
					 ...
					 int[] countArray = TestHelper.count(lotteryList, new Data1_RandomGroup(), false);
					 countArrayList.add(countArray);
					 
					 moneyLeft = TestHelper.testData(moneyLeft, lotteryList, new Data1_RandomGroup(), 
							 new int[] {0,// 0,// 0, 0, 0,// 0, 
								10, 15, 30,// 60,// 54, //90, 150
							},
							true, // 是否打印每一期的数据
							false // 是否打印止损的数据
					 );
